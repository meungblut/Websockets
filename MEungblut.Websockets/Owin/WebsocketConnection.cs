namespace MEungblut.Websockets.Owin
{
    ...
    public abstract class WebSocketConnection
    {
        ...
        /// </summary>
        public TaskQueue QueueSend { get { return this.mWebSocket.SendQueue; } }
        ...
        {
            return this.mWebSocket.Close(status, reason, CancellationToken.None);
        }
        ...
        {
            return this.mWebSocket.SendBinary(buffer, endOfMessage, CancellationToken.None);
        }
        ...
        {
            return this.mWebSocket.SendText(buffer, endOfMessage, CancellationToken.None);
        }
        ...
        {
            return this.mWebSocket.Send(buffer, type, endOfMessage, CancellationToken.None);
        }
        ...
        internal void AcceptSocket(IOwinContext context, IDictionary<string, string> argumentMatches)
        {
            ...
            if (this.AuthenticateRequest(context.Request))
            {
